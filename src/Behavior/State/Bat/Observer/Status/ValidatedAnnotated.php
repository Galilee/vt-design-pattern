...
use Behavior\State\Bat\Status\ValidatedAnnotated as ValidatedAnnotatedState;
use SplSubject;

class ValidatedAnnotated implements \SplObserver
{
    /**
     * (PHP 5 &gt;= 5.1.0)<br/>
    ...
    public function update(SplSubject $subject)
    {
        if ($subject instanceof StatusChanged
            && $subject->getBat()->getStatus() instanceof ValidatedAnnotatedState
        ) {
